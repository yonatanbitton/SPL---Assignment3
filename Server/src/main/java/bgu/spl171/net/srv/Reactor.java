...
public class Reactor<T> implements Server<T> {
    ...
    // We added Connections<T> connections and initialize it, changed the protocol to BidiMessagingProtocol, and the EncoderDecoder to MessageEncoderDecoder
    public Reactor( 
            int numThreads,
            int port,
    ...
    public void serve() {
        ...
        try (Selector selector = Selector.open();
            ...
            // Start to something. Pool / Protocol. 
    ...
    private void handleAccept(ServerSocketChannel serverChan, Selector selector) throws IOException {
        ...
        // We added the handler and the connections ID to the connections Impl
